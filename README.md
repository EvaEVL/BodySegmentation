...
# Насущное
У меня появился вопрос, как работает сегментация изображений и как устроена архитектура модели U-net. Чтобы ответить на свои вопросы, я принялся реализовывать модель для сегментации.
# Данные
